...
if(isset($_SESSION['waiter_login'] ) &&  $_SESSION['waiter_login'] ){
     header('Location:Waiter/Delivery_List.php');
}
...
$query = "SELECT * FROM `user` WHERE name_login = '{$send1}' AND password = '{$send2}' AND role = 'waiter' LIMIT 1";
...
body {
 overflow: hidden;
      ...
      background: url('imag/waiter.jpg') no-repeat center center fixed;
...
<body >
  ...
  <div class="login-box mt-5">
    ...
    <img src="imag/7064394.png" alt="لوگو" class="logoIcon">
    <div class="title">ورود به سیستم گارسون </div>

    <form action="waiter_login.php" method="post">
      <div class="mb-3">
