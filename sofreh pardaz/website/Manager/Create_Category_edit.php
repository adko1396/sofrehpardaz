...
$query = "UPDATE category SET category_name ='{$send1}' WHERE id = {$id}";
...
$query_table = "SELECT * FROM `category` WHERE id = {$id} ";
...
<nav class="navbar navbar-expand-lg shadow-sm fixed-top">
 ...
 <a href="https://github.com/sofrehpardaz" target="_blank" title="GitHub"><img  src="../imag/sofreh pardaz farsi - 2.png" alt="لوگو" class="navbar-logo"></a>
      ...
      <div class="d-flex align-items-center gap-3">
        ...
        <a href="Create_Category.php" class="btn btn-outline-primary btn-sm">داشبورد</a>
  ...
  <div class="container" style="margin-top: 7rem;">
    <div class="section-box">
      ...
      <form class="row g-3 align-items-center mb-4" action="Create_Category_edit.php?id=<?php echo $id?>" method="post">
        <div class="col-md-4">
          <label for="categoryName" class="form-label">نام دسته‌بندی</label>
          <input type="text" class="form-control" id="categoryName" placeholder="مثلاً نوشیدنی" name="form1" value="<?php echo $query['category_name']?>">
        </div>
