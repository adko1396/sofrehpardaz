 ...
 <a href="https://github.com/sofrehpardaz" target="_blank" title="GitHub"><img  src="../imag/sofreh pardaz farsi - 2.png" alt="لوگو" class="navbar-logo"></a>
  ...
  <div class="container" style="margin-top: 7rem;">
    <div class="section-box">
      <h3 class="text-center">مدیریت میزها</h3>
  <!--
<form class="row g-3 justify-content-center mb-4 align-items-center">
  <div class="col-auto">
    <label class="col-form-label fw-bold">تعداد میزها:</label>
  </div>
  <div class="col-md-3">
    <input type="number" class="form-control text-center" placeholder="مثلاً ۵">
  </div>
  <div class="col-md-2">
    <button class="btn btn-outline-success w-100">ثبت</button>
  </div>
</form>
-->
      <table class="table table-bordered text-center">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="Table_Number.php?id=<?php echo $query['id'] ?>">
              <button class="btn btn-outline-dark btn-sm">
                <i class="bi bi-qr-code"></i> چاپ QR
              </button>
              </a>
            </td>
          </tr>
