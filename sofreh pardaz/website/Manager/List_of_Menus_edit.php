...
$query_table = "SELECT * FROM `menu` WHERE id = {$id} ";
...
<nav class="navbar navbar-expand-lg shadow-sm fixed-top">
 ...
 <a href="https://github.com/sofrehpardaz" target="_blank" title="GitHub"><img  src="../imag/sofreh pardaz farsi - 2.png" alt="لوگو" class="navbar-logo"></a>
      ...
      <div class="d-flex align-items-center gap-3">
        ...
        <a href="List_of_Menus.php" class="btn btn-outline-primary btn-sm">داشبورد</a>
  ...
  <div class="container" style="margin-top: 7rem;">
    <div class="section-box">
      ...
      <form class="row g-3 align-items-center mb-4" action="List_of_Menus_edit.php?id=<?php echo $id?>" method="post">
        <div class="col-md-4">
            <label for="categoryName" class="form-label"> نام غذا</label>
          <input type="text" class="form-control" id="categoryName" placeholder="مثلاً نوشیدنی" name="form1" value="<?php echo $query['food_name']?>">
        </div>
        <div class="col-md-4">
          <label for="categoryName" class="form-label">قیمت (ریال)	 </label>
          <input type="text" class="form-control" id="categoryName" placeholder="مثلاً نوشیدنی" name="form2" value="<?php echo $query['price']?>">
        </div>
