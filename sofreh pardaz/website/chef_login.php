...
if(isset($_SESSION['chef_login'] ) &&  $_SESSION['chef_login'] ){
     header('Location:Chef/Registered_Orders_List.php');
}
...
$query = "SELECT * FROM `user` WHERE name_login = '{$send1}' AND password = '{$send2}' AND role = 'chef' LIMIT 1";
...
body {
 overflow: hidden;
      ...
      background: url('imag/chef.jpg') no-repeat center center fixed;
...
<body >
  ...
  <div class="login-box mt-5">
    ...
    <img src="imag/7414124.png" alt="لوگو" class="logoIcon">
    <div class="title">ورود به سیستم آشپز</div>

    <form action="chef_login.php    " method="post">
      <div class="mb-3">
